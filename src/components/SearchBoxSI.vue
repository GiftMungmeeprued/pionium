...
<template>
  ...
  <div
    ...
    role="dialog"
    tabindex="-1"
    aria-labelledby="prefixes-label"
  >
    <div
    ...
    >
      ...
      >
        ...
        <div
          ...
          "isOpenOnFocus": true,
          "preventVisibility": true,
          "apiUrl": "/prefixes.json",
          "outputItemTemplate": "<div role=\"button\" onclick=\"handlePrefix(this)\" class=\"cursor-pointer p-2 space-y-0.5 w-full text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-200 dark:focus:bg-neutral-700\" data-hs-combo-box-output-item><div class=\"grid grid-cols-2 justify-between items-center w-full\"><div data-hs-combo-box-output-item-field=\"name\" data-hs-combo-box-search-text></div><div class=\"pl-10 justify-self-end\" data-hs-combo-box-output-item-field=\"symbol\"></div><div class=\"col-span-2\"><span data-hs-combo-box-output-item-field=\"display\" data-hs-combo-box-search-text></span><span class=\"hidden\" data-hs-combo-box-value></span></div></div></div></div>",
        ...
        >
          <div
            class="hidden relative p-4 border-b border-gray-200 dark:border-neutral-700"
          >
            <label id="prefixes-label" for="prefixes-input" class="sr-only"
              >Search input</label
            >
            <div class="relative">
              <div
              ...
              <input
                ...
                role="combobox"
                aria-expanded="false"
                placeholder="Type the name of the physical constant"
                value=""
                autofocus=""
          ...
          <div class="!mt-0" data-hs-combo-box-output="">
            <div
              class="h-[27svh] tall:max-h-[500px] p-2 overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500"
